...
public class JobScheduler {
    ...
    public JobScheduler(JobLauncher jobLauncher, @Qualifier("weeklyAverageHealthJob") Job weeklyAverageHealthJob,@Qualifier("weeklyHealthReportJob") Job weeklyHealthReportJob,
