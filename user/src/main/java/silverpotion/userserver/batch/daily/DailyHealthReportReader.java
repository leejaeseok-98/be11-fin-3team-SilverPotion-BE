...
@Component
public class DailyHealthReportReader implements ItemReader<User> { //ItemReader<T> 읽어올 데이터 타입 T를 지정

    private final UserRepository userRepository;
    private Iterator<User> userIterator; //Iterator는 리스트 등의 컬렉션에 대해 반복해서 하나씩 꺼낼 수 있게 해주는 도구

    public DailyHealthReportReader(UserRepository userRepository) {
